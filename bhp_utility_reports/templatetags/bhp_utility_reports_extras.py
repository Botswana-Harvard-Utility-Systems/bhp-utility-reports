...
@register.inclusion_tag('bhp_utility_reports/components/paginator_row.html', takes_context=True)
def page_number_row(context):
    ...
    # department = context.get('department', None)
    # status = context.get('status', None)
